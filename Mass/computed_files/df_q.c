...
#else
  #define CASADI_PREFIX(ID) df_q_ ## ID
#endif
...
static const casadi_int casadi_s1[21] = {6, 6, 0, 0, 0, 0, 4, 8, 12, 0, 3, 4, 5, 1, 3, 4, 5, 2, 3, 4, 5};

/* df_q:(i0[11])->(o0[6x6,12nz]) */
...
CASADI_SYMBOL_EXPORT int df_q(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int df_q_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int df_q_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void df_q_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int df_q_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void df_q_release(int mem) {
}

CASADI_SYMBOL_EXPORT void df_q_incref(void) {
}

CASADI_SYMBOL_EXPORT void df_q_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int df_q_n_in(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_int df_q_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real df_q_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* df_q_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const char* df_q_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* df_q_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* df_q_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int df_q_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 1;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
CASADI_SYMBOL_EXPORT int df_q_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
...
#ifdef MATLAB_MEX_FILE
void mex_df_q(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[34];
  casadi_int *iw = 0;
  ...
  casadi_real* res[1] = {0};
  if (argc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"df_q\" failed. Too many input arguments (%d, max 1)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"df_q\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+23);
  --resc;
  res[0] = w+11;
  df_q_incref();
  mem = df_q_checkout();
  i = df_q(arg, res, iw, w+23, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"df_q\" failed.");
  df_q_release(mem);
  df_q_decref();
...
casadi_int main_df_q(casadi_int argc, char* argv[]) {
  casadi_int j;
  casadi_real* a;
  const casadi_real* r;
  casadi_int flag;
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_df_q(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "df_q")==0) {
    mex_df_q(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'df_q'");
}
#endif
CASADI_SYMBOL_EXPORT int main(int argc, char* argv[]) {
  if (argc<2) {
    /* name error */
  } else if (strcmp(argv[1], "df_q")==0) {
    return main_df_q(argc-2, argv+2);
  }
  fprintf(stderr, "First input should be a command string. Possible values: 'df_q'\nNote: you may use function.generate_input to create a command string.\n");
  return 1;
}
#ifdef __cplusplus
} /* extern "C" */
